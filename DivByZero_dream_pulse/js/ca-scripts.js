...
function toggleColors() {
  ...
  let rectangle = document.querySelectorAll(".d-inline-block tm-white-rect");
  for (i = 0; i < rectangle.length; i++) {
    rectangle[i].classList.add("d-inline-block tm-blue-rect");
    rectangle[i].classList.remove("d-inline-block tm-white-rect");
  }
}

function hideElement() {
  //<ul class="nav flex-row tm-social-links">  <!--todo: Hide social links-->
  var socialLink = document.querySelector(".nav flex-row tm-social-links");
